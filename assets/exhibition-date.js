...
{
	if (region.aO._ === region.aZ._)
	{
		return 'on line ' + region.aO._;
	}
	return 'on lines ' + region.aO._ + ' through ' + region.aZ._;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bN: 'hidden', bI: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bN: 'mozHidden', bI: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bN: 'msHidden', bI: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bN: 'webkitHidden', bI: 'webkitvisibilitychange' }
		: { bN: 'hidden', bI: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bS, request.aQ, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a1: fragment, a5: host, bc: path, be: port_, bj: protocol, bk: query};
	});
...
var $author$project$ExhibitionDate$CartInitialised = function (a) {
	return {$: 7, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bG: false, al: r.al, aw: r.aw, a2: r.a2, bS: r.bS, b0: r.b0, bx: r.bx, aQ: r.aQ}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{al: r.al, aw: r.aw, a2: _List_Nil, bS: 'POST', b0: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, aQ: r.aQ});
};
var $author$project$ExhibitionDate$cartInitialisePost = $elm$http$Http$post(
	{
		al: $elm$http$Http$emptyBody,
		aw: $elm$http$Http$expectWhatever($author$project$ExhibitionDate$CartInitialised),
		aQ: '/cart/clear.js'
	});
var $author$project$ExhibitionDate$CartItem = F4(
	function (lineItemKey, variantId, quantity, exhibitionDateTitle) {
		return {au: exhibitionDateTitle, aE: lineItemKey, e: quantity, q: variantId};
	});
...
var $author$project$ExhibitionDate$cartItemsDecoder = A2(
	...
	'items',
	$elm$json$Json$Decode$list($author$project$ExhibitionDate$cartItemDecoder));
var $author$project$ExhibitionDate$ClosedDate = function (closedOn) {
	return {an: closedOn};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aW: col, bJ: contextStack, bg: problem, bq: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bq, s.aW, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aW: 1, c: s.c, d: s.d, b: s.b + 1, bq: s.bq + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aW: s.aW + 1, c: s.c, d: s.d, b: newOffset, bq: s.bq, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bq, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aW: newCol, c: s.c, d: s.d, b: newOffset, bq: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aW: col, bg: problem, bq: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bq, p.aW, p.bg);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aW: 1, c: _List_Nil, d: 1, b: 0, bq: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$ExhibitionDate$dateFromString = function (maybeDate) {
	var _v0 = $justinmimbs$date$Date$fromIsoString(maybeDate);
	if (!_v0.$) {
		var aDate = _v0.a;
		return aDate;
	} else {
		return $justinmimbs$date$Date$fromRataDie(1);
	}
};
var $author$project$ExhibitionDate$dateFromStringList = function (maybeDateStrings) {
	return $elm$json$Json$Decode$succeed(
		A2(
			$elm$core$List$map,
			function (maybeDate) {
				return $author$project$ExhibitionDate$dateFromString(maybeDate);
			},
			maybeDateStrings));
};
var $author$project$ExhibitionDate$closedDateDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$ExhibitionDate$ClosedDate,
	A2(
		$elm$json$Json$Decode$andThen,
		$author$project$ExhibitionDate$dateFromStringList,
		A2(
			$elm$json$Json$Decode$field,
			'museum_closed_on',
			$elm$json$Json$Decode$list($elm$json$Json$Decode$string))));
var $author$project$ExhibitionDate$closedDateListDecoder = $elm$json$Json$Decode$list($author$project$ExhibitionDate$closedDateDecoder);
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$ExhibitionDate$Exhibition = F3(
	function (title, startDate, endDate) {
		return {Z: endDate, U: startDate, M: title};
	});
...
var $author$project$ExhibitionDate$exhibitionDecoder = A4(
	...
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ExhibitionDate$dateFromString,
		A2($elm$json$Json$Decode$field, 'start_date', $elm$json$Json$Decode$string)),
	A2(
		$elm$json$Json$Decode$map,
		$author$project$ExhibitionDate$dateFromString,
		A2($elm$json$Json$Decode$field, 'end_date', $elm$json$Json$Decode$string)));
var $author$project$ExhibitionDate$exhibitionListDecoder = $elm$json$Json$Decode$list($author$project$ExhibitionDate$exhibitionDecoder);
var $author$project$ExhibitionDate$GiftAidCopy = F3(
	function (heading, info, declaration) {
		return {at: declaration, ax: heading, ay: info};
	});
var $author$project$ExhibitionDate$giftAidCopyDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$ExhibitionDate$GiftAidCopy,
	A2($elm$json$Json$Decode$field, 'gift_aid_heading', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'gift_aid_info', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'gift_aid_declaration', $elm$json$Json$Decode$string));
...
var $CurrySoftware$elm_datepicker$DatePicker$init = _Utils_Tuple2(
	{
		p: $elm$core$Maybe$Just($CurrySoftware$elm_datepicker$DatePicker$Date$initDate),
		C: false,
		u: $elm$core$Maybe$Nothing,
		y: false,
		G: $CurrySoftware$elm_datepicker$DatePicker$Date$initDate
	},
...
var $author$project$ExhibitionDate$ProductDetails = F3(
	function (id, variants, variantDescriptions) {
		return {k: id, ae: variantDescriptions, V: variants};
	});
var $author$project$ExhibitionDate$ProductVariant = F3(
	function (id, title, price) {
		return {k: id, bf: price, M: title};
	});
var $author$project$ExhibitionDate$productVariantDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$ExhibitionDate$ProductVariant,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'price', $elm$json$Json$Decode$int));
var $author$project$ExhibitionDate$productDetailsDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$ExhibitionDate$ProductDetails,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'variants',
		$elm$json$Json$Decode$list($author$project$ExhibitionDate$productVariantDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'variantDescriptions',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$ExhibitionDate$init = function (flags) {
	var decodedProductDetails = function () {
		var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$productDetailsDecoder, flags.F);
		if (!_v5.$) {
			var goodProductDetails = _v5.a;
			return {k: goodProductDetails.k, ae: goodProductDetails.ae, V: goodProductDetails.V};
		} else {
			var error = _v5.a;
			return {k: 0, ae: _List_Nil, V: _List_Nil};
		}
	}();
	var decodedInitialCartItems = function () {
		var _v4 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$cartItemsDecoder, flags.az);
		if (!_v4.$) {
			var goodCartItems = _v4.a;
			return goodCartItems;
		} else {
			return _List_Nil;
		}
	}();
	var decodedGiftAidCopy = function () {
		var _v3 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$giftAidCopyDecoder, flags.S);
		if (!_v3.$) {
			var goodGiftAidCopy = _v3.a;
			return goodGiftAidCopy;
		} else {
			return {at: '', ax: '', ay: ''};
		}
	}();
	var decodedExhibitionList = function () {
		var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$exhibitionListDecoder, flags.B);
		if (!_v2.$) {
			var goodExhibitionData = _v2.a;
			return goodExhibitionData;
		} else {
			return _List_fromArray(
				[
					{
					Z: $justinmimbs$date$Date$fromRataDie(1),
					U: $justinmimbs$date$Date$fromRataDie(1),
					M: ''
				}
				]);
		}
	}();
	var decodedClosedDateList = function () {
		var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$closedDateListDecoder, flags.Q);
		if (!_v1.$) {
			var goodClosedDateData = _v1.a;
			return goodClosedDateData;
		} else {
			return _List_fromArray(
				[
					{an: _List_Nil}
	...
	return _Utils_Tuple2(
		{
			...
			I: datePicker,
			B: decodedExhibitionList,
			S: decodedGiftAidCopy,
			r: false,
			F: decodedProductDetails
		},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Platform$Cmd$map, $author$project$ExhibitionDate$ToDatePickerMsg, datePickerCmd),
					($elm$core$List$length(decodedInitialCartItems) > 0) ? $author$project$ExhibitionDate$cartInitialisePost : $elm$core$Platform$Cmd$none
				])));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$ExhibitionDate$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ExhibitionDate$fmAttendanceDateFormat = 'dd/MM/yyyy';
...
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.bF, 0, date.aJ);
};
...
var $justinmimbs$date$Date$toWeekDate = function (_v0) {
	...
	return {
		...
		bB: wy,
		b3: $justinmimbs$date$Date$numberToWeekday(wdn)
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aW: col, c: s0.c, d: s0.d, b: offset, bq: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bq, s.aW, s);
	};
};
...
var $justinmimbs$date$Date$language_en = {
	...
	aH: $justinmimbs$date$Date$monthToName,
	aj: A2(
		$elm$core$Basics$composeR,
		$justinmimbs$date$Date$monthToName,
		$elm$core$String$left(3)),
	aR: $justinmimbs$date$Date$weekdayToName,
	O: A2(
		$elm$core$Basics$composeR,
...
var $author$project$ExhibitionDate$attendanceDateString = function (maybeDate) {
	if (maybeDate.$ === 1) {
		return 'No date selected';
	} else {
		var aDate = maybeDate.a;
		return A2($justinmimbs$date$Date$format, $author$project$ExhibitionDate$fmAttendanceDateFormat, aDate);
	}
};
var $author$project$ExhibitionDate$CartUpdated = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$ExhibitionDate$cartAddEncoder = function (posts) {
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'id',
									$elm$json$Json$Encode$int(post.k)),
									_Utils_Tuple2(
									'properties',
									post.r ? $elm$json$Json$Encode$object(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'Exhibition',
												$elm$json$Json$Encode$string(post.av)),
												_Utils_Tuple2(
												'Date',
												$elm$json$Json$Encode$string(post.ak)),
												_Utils_Tuple2(
												'GiftAidDeclaration',
												$elm$json$Json$Encode$bool(post.r))
									...
									_Utils_Tuple2(
									'quantity',
									$elm$json$Json$Encode$int(post.e)),
									_Utils_Tuple2(
									'sections',
									A2(
										$elm$json$Json$Encode$list,
	...
	return $elm$http$Http$post(
		{
			...
			aw: $elm$http$Http$expectWhatever($author$project$ExhibitionDate$CartUpdated),
			aQ: '/cart/add.js'
		});
};
...
var $author$project$ExhibitionDate$cartUpdateEncoder = function (posts) {
	var updates = $elm$core$Dict$fromList(
		A2(
			$elm$core$List$map,
			function (post) {
				return _Utils_Tuple2(
					$elm$core$String$fromInt(post.k),
					post.e);
			},
			posts));
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'updates',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$int, updates))
			]));
};
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.bF - 1)) + ($justinmimbs$date$Date$monthToNumber(date.ba) - 1)) + n;
...
var $CurrySoftware$elm_datepicker$DatePicker$defaultSettings = {
	am: $CurrySoftware$elm_datepicker$DatePicker$formatCell,
	Y: $CurrySoftware$elm_datepicker$DatePicker$off,
	P: 'elm-datepicker--',
	ao: _List_Nil,
	...
	aG: $CurrySoftware$elm_datepicker$DatePicker$Date$formatMonth,
	aK: $justinmimbs$date$Date$fromIsoString,
	aL: 'Please pick a date...',
	aS: $elm$core$String$fromInt
};
...
var $author$project$ExhibitionDate$lastExhibitionEndDate = function (model) {
	return A3(
		...
		A2(
			...
			A3(
				...
				1,
				9,
				$CurrySoftware$elm_datepicker$DatePicker$getInitialDate(model.I)),
			$elm$core$List$head(
...
var $author$project$ExhibitionDate$datePickerSettings = function (model) {
	var isDisabled = F2(
		function (today, date) {
			return (!(!A2(
				$justinmimbs$date$Date$compare,
				A3($justinmimbs$date$Date$add, 3, -1, today),
				date))) || (A2(
				...
				$elm$core$List$concat(
					A2(
						...
						model.Q))) || (A2(
				$justinmimbs$date$Date$compare,
				$author$project$ExhibitionDate$lastExhibitionEndDate(model),
				date) !== 2));
		});
...
var $author$project$ExhibitionDate$hasGiftAidTicket = F2(
	function (allVariants, cartItems) {
		var giftAidIds = A2(
			$elm$core$List$map,
			function (variant) {
				return variant.k;
			...
			A2(
				...
				function (variant) {
					return A2(
						...
						'gift aid',
						$elm$core$String$toLower(variant.M));
				},
				allVariants));
		var cartItemVariantIds = A2(
			$elm$core$List$map,
			function (item) {
				return item.q;
			},
		...
		return $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (id) {
					return A2($elm$core$List$member, id, giftAidIds);
				},
				cartItemVariantIds)) > 0;
	});
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$ExhibitionDate$variantsInCart = function (cartItems) {
	return A2(
		$elm$core$List$map,
		function (item) {
			return item.q;
...
var $author$project$ExhibitionDate$addOneOfVariant = F2(
	function (initialCartItems, variantId) {
		return (!A2(
			$elm$core$List$member,
			variantId,
			$author$project$ExhibitionDate$variantsInCart(initialCartItems))) ? _Utils_ap(
			initialCartItems,
			_List_fromArray(
				[
					{au: '', aE: '', e: 1, q: variantId}
				])) : A2(
			$elm$core$List$map,
			function (item) {
				return _Utils_eq(item.q, variantId) ? _Utils_update(
					item,
					{e: item.e + 1}) : item;
			},
			initialCartItems);
	});
var $author$project$ExhibitionDate$maxTickets = 7;
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$ExhibitionDate$reachedMaxTickets = function (itemsInCart) {
	return _Utils_cmp(
		$elm$core$List$sum(
			A2(
				$elm$core$List$map,
				...
				itemsInCart)),
		$author$project$ExhibitionDate$maxTickets) > -1;
};
...
var $author$project$ExhibitionDate$maybeExhibitionTitle = function (_v0) {
	var date = _v0.t;
	var exhibitionList = _v0.B;
	return A2(
		$elm$core$Maybe$withDefault,
		'',
		$elm$core$List$head(
				...
				A2(
					...
					function (exhibition) {
						var selectedDate = function () {
							if (!date.$) {
								var aSelectedDate = date.a;
								return aSelectedDate;
							} else {
								return $justinmimbs$date$Date$fromRataDie(2);
							}
						}();
						return A3($justinmimbs$date$Date$isBetween, exhibition.U, exhibition.Z, selectedDate) ? exhibition.M : '';
					},
					exhibitionList))));
};
var $author$project$ExhibitionDate$ticketDetailString = function (model) {
	var _v0 = model.t;
	if (_v0.$ === 1) {
		return '';
	} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$ExhibitionDate$maybeExhibitionTitle(model),
					A2($justinmimbs$date$Date$format, $author$project$ExhibitionDate$fmDateFormatWithWeekday, aDate)
				]));
	}
};
		...
		switch (msg.$) {
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{p: $elm$core$Maybe$Nothing, u: $elm$core$Maybe$Nothing, y: false}),
					...
					var dateEvent = function () {
						...
						if (_v5.$ === 1) {
							...
							if (_v5.a === '') {
								...
								var rawInput = _v5.a;
								var _v6 = settings.aK(rawInput);
								if (!_v6.$) {
									var date = _v6.a;
									return settings.bR(date) ? $CurrySoftware$elm_datepicker$DatePicker$FailedInput(
...
var $author$project$ExhibitionDate$updateVariantQuantity = F3(
	function (initialCartItems, variantId, input) {
		return (!A2(
			$elm$core$List$member,
			variantId,
			$author$project$ExhibitionDate$variantsInCart(initialCartItems))) ? _Utils_ap(
...
var $author$project$ExhibitionDate$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
			...
			case 2:
				var variantId = msg.a;
				return _Utils_Tuple2(
					A2($author$project$ExhibitionDate$maybeAddVariant, model, variantId),
					$elm$core$Platform$Cmd$none);
			case 3:
				var variantId = msg.a;
			...
			case 6:
				return _Utils_Tuple2(
					model,
					$elm$browser$Browser$Navigation$load('/cart'));
			case 7:
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				return _Utils_Tuple2(
					model,
					model.af ? $author$project$ExhibitionDate$cartAddPost(
						A2(
							$elm$core$List$map,
							function (item) {
								return {
									ak: $author$project$ExhibitionDate$attendanceDateString(model.t),
									av: $author$project$ExhibitionDate$ticketDetailString(model),
									r: model.r,
									k: item.q,
									e: item.e
								};
...
var $author$project$ExhibitionDate$fmDateFormat = 'd MMM yyyy';
...
var $author$project$ExhibitionDate$orderExhibitionListByStartDate = function (exhibitionList) {
	return A2(
		$elm$core$List$sortWith,
		F2(
			function (a, b) {
				return A2($justinmimbs$date$Date$compare, a.U, b.U);
			}),
		exhibitionList);
};
...
var $CurrySoftware$elm_datepicker$DatePicker$prepareDates = F2(
	function (date, firstDayOfWeek) {
		...
		return {
			aX: A4($justinmimbs$date$Date$range, 11, 1, start, end),
			ap: date
		};
	});
...
var $CurrySoftware$elm_datepicker$DatePicker$datePicker = F3(
	function (pickedDate, settings, model) {
		...
		var firstDayOffset = $justinmimbs$date$Date$weekdayToNumber(settings.ai) - 1;
		...
		var _v0 = A2($CurrySoftware$elm_datepicker$DatePicker$prepareDates, currentDate, settings.ai);
		var currentMonth = _v0.ap;
		var currentDates = _v0.aX;
		var dayList = A2(
			$elm$core$List$map,
			function (rowDays) {
				return A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											(!$CurrySoftware$elm_datepicker$DatePicker$yearRangeActive(settings.Y)) ? $elm$html$Html$text(
											settings.aS(
...
var $CurrySoftware$elm_datepicker$DatePicker$view = F3(
	function (pickedDate, settings, _v0) {
		...
		var potentialInputId = A3(
			...
			A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, settings.aC));
		var inputClasses = _Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2(settings.P + 'input', true)
				]),
			settings.aB);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							A2($elm$core$Maybe$withDefault, '', settings.aD)),
		...
		var dateInput = inputCommon(
			_List_fromArray(
				[
					$elm$html$Html$Attributes$placeholder(settings.aL),
					$elm$html$Html$Attributes$value(
					A2(
						$elm$core$Maybe$withDefault,
						A2(
		...
		var containerClassList = A2(
			$elm$core$List$cons,
			_Utils_Tuple2(settings.P + 'container', true),
			settings.ao);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					dateInput,
					model.y ? A3($CurrySoftware$elm_datepicker$DatePicker$datePicker, pickedDate, settings, model) : $elm$html$Html$text('')
				]));
	});
...
var $author$project$ExhibitionDate$viewGiftAidDeclaration = F2(
	function (giftAidCopy, giftAidDeclaration) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(giftAidCopy.ay)
						])),
					A2(
					$elm$html$Html$label,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_Nil),
							$elm$html$Html$text(giftAidCopy.at)
						]))
				]));
	});
...
var $author$project$ExhibitionDate$viewProductVariantDescription = F2(
	function (variantId, productVariantDescriptions) {
		var variantIds = A2(
			$elm$core$List$map,
			function (aPair) {
				return A2(
					...
					$elm$core$String$toInt(
						A2(
							...
							'0',
							$elm$core$List$head(
								A2($elm$core$List$take, 2, aPair)))));
			},
			A2(
				$elm$core$List$map,
				function (pair) {
					return A2($elm$core$String$split, ':', pair);
				},
				productVariantDescriptions));
		var variantDescriptions = A2(
			$elm$core$List$map,
			function (aPair) {
				return A2(
					$elm$core$Maybe$withDefault,
			...
			A2(
				...
				productVariantDescriptions));
		var filteredVariantDescriptions = A2(
			$elm$core$List$filter,
			function (_v0) {
				var id = _v0.k;
				var description = _v0.ah;
				return ($elm$core$String$length(
					A3($elm$core$String$replace, ' ', '', description)) > 0) && _Utils_eq(id, variantId);
			},
			A3(
				$elm$core$List$map2,
				F2(
					function (id, description) {
						return {ah: description, k: id};
					}),
				variantIds,
				variantDescriptions));
		var filteredVariantDescription = A2(
			$elm$core$Maybe$withDefault,
			{ah: '', k: 0},
			$elm$core$List$head(filteredVariantDescriptions));
		return _Utils_eq(filteredVariantDescription.k, variantId) ? $elm$html$Html$text(filteredVariantDescription.ah) : $elm$html$Html$text('');
	});
var $author$project$ExhibitionDate$ClickedAddVariant = function (a) {
	return {$: 2, a: a};
};
var $author$project$ExhibitionDate$ClickedRemoveVariant = function (a) {
	return {$: 3, a: a};
};
var $author$project$ExhibitionDate$InputVariantQuantity = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
...
var $author$project$ExhibitionDate$quantityFromVariantId = F2(
	function (cartItems, variantId) {
		return $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function (itemWithVariantId) {
					return itemWithVariantId.e;
				},
				A2(
					$elm$core$List$filter,
					function (item) {
						return _Utils_eq(item.q, variantId);
					},
					cartItems)));
	});
var $author$project$ExhibitionDate$viewQuantity = F2(
	function (cartItems, variantId) {
		var quantity = A2($author$project$ExhibitionDate$quantityFromVariantId, cartItems, variantId);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('quantity__button minus'),
							$elm$html$Html$Attributes$disabled(quantity < 1),
							$elm$html$Html$Events$onClick(
							$author$project$ExhibitionDate$ClickedRemoveVariant(variantId))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('-')
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('quantity__input'),
							$elm$html$Html$Attributes$value(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('quantity__button plus'),
							$elm$html$Html$Events$onClick(
							$author$project$ExhibitionDate$ClickedAddVariant(variantId))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('+')
...
var $author$project$ExhibitionDate$viewProductVariants = F3(
	function (cartItems, productVariants, productVariantDescriptions) {
		return A2(
			$elm$html$Html$tbody,
			_List_Nil,
			A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($author$project$ExhibitionDate$viewProductVariantDescription, variant.k, productVariantDescriptions)
											]))
									])),
								A2(
								$elm$html$Html$td,
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$ExhibitionDate$viewPrice(variant.bf))
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										A2($author$project$ExhibitionDate$viewQuantity, cartItems, variant.k)
									]))
							]));
				},
				productVariants));
	});
var $author$project$ExhibitionDate$viewProductVariantSelector = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Ticket type')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Price per ticket')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$ExhibitionDate$ClickedUpdateCart)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Update basket')
					]))
			]));
};
var $author$project$ExhibitionDate$view = function (model) {
	return (!model.af) ? $elm$html$Html$text('') : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('page-width')
			]),
		_List_fromArray(
			[
				A2(
				...
				A2(
					...
					$author$project$ExhibitionDate$orderExhibitionListByStartDate(model.B))),
				_Utils_eq(model.t, $elm$core$Maybe$Nothing) ? A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Select visit date')
							])),
						A2(
						$elm$html$Html$map,
						$author$project$ExhibitionDate$ToDatePickerMsg,
						A3(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$ExhibitionDate$ClickedResetDatePicker)
							]),
						_List_fromArray(
							[
...
var $author$project$ExhibitionDate$main = $elm$browser$Browser$element(
	{bP: $author$project$ExhibitionDate$init, b$: $author$project$ExhibitionDate$subscriptions, b1: $author$project$ExhibitionDate$update, b2: $author$project$ExhibitionDate$view});
								...
								function (exhibitionList) {
									return A2(
										...
										function (closedDateList) {
											return $elm$json$Json$Decode$succeed(
												{Q: closedDateList, B: exhibitionList, S: giftAidCopy, az: initialCart, F: productDetails});
										},
										A2($elm$json$Json$Decode$field, 'closedDateList', $elm$json$Json$Decode$value));
								},
								A2($elm$json$Json$Decode$field, 'exhibitionList', $elm$json$Json$Decode$value));
						},
						A2($elm$json$Json$Decode$field, 'giftAidCopy', $elm$json$Json$Decode$value));
				},
				A2($elm$json$Json$Decode$field, 'initialCart', $elm$json$Json$Decode$value));
		},
		A2($elm$json$Json$Decode$field, 'productDetails', $elm$json$Json$Decode$value)))(0)}});}(this));