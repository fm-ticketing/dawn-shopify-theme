...
{
	if (region.aM._ === region.aX._)
	{
		return 'on line ' + region.aM._;
	}
	return 'on lines ' + region.aM._ + ' through ' + region.aX._;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bQ, request.aO, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a$: fragment, a3: host, ba: path, bc: port_, bh: protocol, bi: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bE: false, aj: r.aj, at: r.at, a0: r.a0, bQ: r.bQ, b_: r.b_, bv: r.bv, aO: r.aO}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aj: r.aj, at: r.at, a0: _List_Nil, bQ: 'POST', b_: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing, aO: r.aO});
};
var $author$project$ExhibitionDate$cartInitialisePost = $elm$http$Http$post(
	{
		aj: $elm$http$Http$emptyBody,
		at: $elm$http$Http$expectWhatever($author$project$ExhibitionDate$CartInitialised),
		aO: '/cart/clear.js'
	});
var $author$project$ExhibitionDate$CartItem = F4(
	function (lineItemKey, variantId, quantity, exhibitionDateTitle) {
		return {as: exhibitionDateTitle, aC: lineItemKey, f: quantity, q: variantId};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aU: col, bH: contextStack, be: problem, bo: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bo, s.aU, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aU: 1, c: s.c, d: s.d, b: s.b + 1, bo: s.bo + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aU: s.aU + 1, c: s.c, d: s.d, b: newOffset, bo: s.bo, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bo, s.aU, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aU: newCol, c: s.c, d: s.d, b: newOffset, bo: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aU: col, be: problem, bo: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bo, p.aU, p.be);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aU: 1, c: _List_Nil, d: 1, b: 0, bo: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$ExhibitionDate$Exhibition = F3(
	function (title, startDate, endDate) {
		return {Z: endDate, V: startDate, M: title};
	});
...
var $author$project$ExhibitionDate$GiftAidCopy = F3(
	function (heading, info, declaration) {
		return {ar: declaration, au: heading, av: info};
	});
...
var $author$project$ExhibitionDate$init = function (flags) {
	var decodedProductDetails = function () {
		var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$productDetailsDecoder, flags.z);
		if (!_v5.$) {
			var goodProductDetails = _v5.a;
			return {j: goodProductDetails.j, ae: goodProductDetails.ae, N: goodProductDetails.N};
		} else {
			var error = _v5.a;
			return {j: 0, ae: _List_Nil, N: _List_Nil};
		}
	}();
	var decodedInitialCartItems = function () {
		var _v4 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$cartItemsDecoder, flags.aw);
		if (!_v4.$) {
	...
	var decodedGiftAidCopy = function () {
		var _v3 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$giftAidCopyDecoder, flags.T);
		if (!_v3.$) {
	...
	var decodedExhibitionList = function () {
		var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$exhibitionListDecoder, flags.C);
		if (!_v2.$) {
			...
			return _List_fromArray(
				[
					...
					V: $justinmimbs$date$Date$fromRataDie(1),
					M: ''
				}
				]);
		}
	...
	var decodedClosedDateList = function () {
		var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExhibitionDate$closedDateListDecoder, flags.R);
		if (!_v1.$) {
	...
	return _Utils_Tuple2(
		{
			...
			l: decodedInitialCartItems,
			R: decodedClosedDateList,
			w: $elm$core$Maybe$Nothing,
			I: datePicker,
			C: decodedExhibitionList,
			T: decodedGiftAidCopy,
			r: false,
			z: decodedProductDetails
		},
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									...
									post.r ? $elm$json$Json$Encode$object(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'Exhibition',
												$elm$json$Json$Encode$string(post.aB)),
												_Utils_Tuple2(
												'GiftAidDeclaration',
									...
									_Utils_Tuple2(
									'quantity',
									$elm$json$Json$Encode$int(post.f)),
									_Utils_Tuple2(
									'sections',
									A2(
										$elm$json$Json$Encode$list,
	...
	return $elm$http$Http$post(
		{
			...
			at: $elm$http$Http$expectWhatever($author$project$ExhibitionDate$CartUpdated),
			aO: '/cart/add.js'
		});
};
...
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.bD, 0, date.aH);
};
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.bD - 1)) + ($justinmimbs$date$Date$monthToNumber(date.a8) - 1)) + n;
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aU: col, c: s0.c, d: s0.d, b: offset, bo: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bo, s.aU, s);
	};
};
...
var $justinmimbs$date$Date$language_en = {
	aq: $justinmimbs$date$Date$withOrdinalSuffix,
...
var $CurrySoftware$elm_datepicker$DatePicker$defaultSettings = {
	ak: $CurrySoftware$elm_datepicker$DatePicker$formatCell,
	Y: $CurrySoftware$elm_datepicker$DatePicker$off,
	Q: 'elm-datepicker--',
	am: _List_Nil,
	ao: $justinmimbs$date$Date$format('yyyy-MM-dd'),
	ap: $CurrySoftware$elm_datepicker$DatePicker$Date$formatDay,
	ah: 6,
	ax: _List_fromArray(
		[
	...
	aE: $CurrySoftware$elm_datepicker$DatePicker$Date$formatMonth,
	aI: $justinmimbs$date$Date$fromIsoString,
	aJ: 'Please pick a date...',
			...
			A2(
				...
				A2(
					...
					function (exhibition) {
						...
						return A3($justinmimbs$date$Date$isBetween, exhibition.V, exhibition.Z, selectedDate) ? exhibition.M : '';
					},
					exhibitionList))));
};
					...
					var dateEvent = function () {
						...
						if (_v5.$ === 1) {
							...
							if (_v5.a === '') {
								...
								var rawInput = _v5.a;
								var _v6 = settings.aI(rawInput);
								if (!_v6.$) {
									var date = _v6.a;
									return settings.bP(date) ? $CurrySoftware$elm_datepicker$DatePicker$FailedInput(
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2($author$project$ExhibitionDate$addOneOfVariant, model.l, variantId)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var variantId = msg.a;
				var updatedCartItems = A2(
					...
					model.l);
				var newCartContainsGiftAidTicket = A2($author$project$ExhibitionDate$hasGiftAidTicket, model.z.N, updatedCartItems);
				var updatedGiftAidDeclaration = (!newCartContainsGiftAidTicket) ? false : model.r;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2($author$project$ExhibitionDate$removeOneOfVariant, model.l, variantId),
			...
			case 4:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A3($author$project$ExhibitionDate$updateVariantQuantity, model.l, variantId, input)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
						...
						A2(
							...
							function (item) {
								return {
									r: model.r,
									j: item.q,
									aB: $author$project$ExhibitionDate$ticketDetailString(model),
									f: item.f
								};
							},
							model.l)) : $author$project$ExhibitionDate$cartUpdatePost(
						A2(
							$elm$core$List$map,
							function (item) {
								return {j: item.q, f: item.f};
							},
							model.l)));
		}
	});
...
var $author$project$ExhibitionDate$orderExhibitionListByStartDate = function (exhibitionList) {
	return A2(
		...
		F2(
			function (a, b) {
				return A2($justinmimbs$date$Date$compare, a.V, b.V);
			}),
		exhibitionList);
};
...
var $CurrySoftware$elm_datepicker$DatePicker$prepareDates = F2(
	function (date, firstDayOfWeek) {
		...
		return {
			aV: A4($justinmimbs$date$Date$range, 11, 1, start, end),
			an: date
		};
	});
...
var $CurrySoftware$elm_datepicker$DatePicker$view = F3(
	function (pickedDate, settings, _v0) {
		...
		var potentialInputId = A3(
			...
			A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, settings.az));
		var inputClasses = _Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2(settings.Q + 'input', true)
				]),
			settings.ay);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							A2($elm$core$Maybe$withDefault, '', settings.aA)),
		...
		var dateInput = inputCommon(
			_List_fromArray(
				[
					$elm$html$Html$Attributes$placeholder(settings.aJ),
					$elm$html$Html$Attributes$value(
					A2(
						$elm$core$Maybe$withDefault,
						A2(
							$elm$core$Maybe$withDefault,
							'',
							A2($elm$core$Maybe$map, settings.ao, pickedDate)),
						model.t))
				]));
		var containerClassList = A2(
			$elm$core$List$cons,
			_Utils_Tuple2(settings.Q + 'container', true),
			settings.am);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(giftAidCopy.au)
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(giftAidCopy.av)
						])),
					A2(
					$elm$html$Html$label,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_Nil),
							$elm$html$Html$text(giftAidCopy.ar)
						]))
				]));
	});
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$ExhibitionDate$viewPrice(variant.bd))
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($author$project$ExhibitionDate$viewProductVariants, model.l, model.z.N, model.z.ae)
					])),
				A2($author$project$ExhibitionDate$hasGiftAidTicket, model.z.N, model.l) ? A2($author$project$ExhibitionDate$viewGiftAidDeclaration, model.T, model.r) : $elm$html$Html$text(''),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$ExhibitionDate$orderExhibitionListByStartDate(model.C))),
...
var $author$project$ExhibitionDate$main = $elm$browser$Browser$element(
	{bN: $author$project$ExhibitionDate$init, bZ: $author$project$ExhibitionDate$subscriptions, b$: $author$project$ExhibitionDate$update, b0: $author$project$ExhibitionDate$view});
								...
								function (exhibitionList) {
									return A2(
										...
										function (closedDateList) {
											return $elm$json$Json$Decode$succeed(
												{R: closedDateList, C: exhibitionList, T: giftAidCopy, aw: initialCart, z: productDetails});
										},
