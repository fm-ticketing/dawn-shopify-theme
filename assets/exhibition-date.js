...
{
	if (region.aB.V === region.aN.V)
	{
		return 'on line ' + region.aB.V;
	}
	return 'on lines ' + region.aB.V + ' through ' + region.aN.V;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aS: fragment, aW: host, a1: path, a3: port_, a8: protocol, a9: query};
	});
...
var $author$project$ExhibitionDate$CartItem = F3(
	function (lineItemKey, variantId, quantity) {
		return {ar: lineItemKey, k: quantity, y: variantId};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aK: col, bz: contextStack, a5: problem, bf: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bf, s.aK, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aK: 1, c: s.c, d: s.d, b: s.b + 1, bf: s.bf + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aK: s.aK + 1, c: s.c, d: s.d, b: newOffset, bf: s.bf, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bf, s.aK, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aK: newCol, c: s.c, d: s.d, b: newOffset, bf: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aK: col, a5: problem, bf: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bf, p.aK, p.a5);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aK: 1, c: _List_Nil, d: 1, b: 0, bf: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$ExhibitionDate$addOneOfVariant = F2(
	function (initialCartItems, variantId) {
		return (!A2(
			...
			$elm$core$List$map,
			function (item) {
				return _Utils_eq(item.y, variantId) ? _Utils_update(
					item,
					{k: item.k + 1}) : item;
			},
			initialCartItems);
									...
									$elm$json$Json$Encode$object(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'Exhibition',
												$elm$json$Json$Encode$string(post.ac))
											]))),
									_Utils_Tuple2(
									'quantity',
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bw: false, aH: r.aH, aP: r.aP, aT: r.aT, bI: r.bI, bS: r.bS, bm: r.bm, bo: r.bo}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aH: r.aH, aP: r.aP, aT: _List_Nil, bI: 'POST', bS: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bo: r.bo});
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aK: col, c: s0.c, d: s0.d, b: offset, bf: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bf, s.aK, s);
	};
};
		...
		switch (msg.$) {
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{n: $elm$core$Maybe$Nothing, r: $elm$core$Maybe$Nothing, w: false}),
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$ExhibitionDate$addOneOfVariant, model.p, variantId)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var variantId = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A2($author$project$ExhibitionDate$removeOneOfVariant, model.p, variantId)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				var variantId = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p: A3($author$project$ExhibitionDate$updateVariantQuantity, model.p, variantId, input)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
					...
					$author$project$ExhibitionDate$cartAddPost(
						A2(
							...
							function (item) {
								return {
									q: item.y,
									ac: $author$project$ExhibitionDate$ticketDetailString(model),
									k: item.k
								};
							},
							model.p)));
	...
	function (pickedDate, settings, _v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					dateInput,
					model.w ? A3($CurrySoftware$elm_datepicker$DatePicker$datePicker, pickedDate, settings, model) : $elm$html$Html$text('')
				]));
	});
var $author$project$ExhibitionDate$ClickedUpdateCart = {$: 6};
		...
		return $elm$core$List$sum(
			A2(
				...
				function (itemWithVariantId) {
					return itemWithVariantId.k;
				},
				A2(
					$elm$core$List$filter,
					function (item) {
						return _Utils_eq(item.y, variantId);
					},
					cartItems)));
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					model.F)),
				_Utils_eq(model.u, $elm$core$Maybe$Nothing) ? A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2($author$project$ExhibitionDate$viewProductVariantSelector, model.p, model.P._)
					]))
			]));
};
